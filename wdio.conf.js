...
exports.config = {
    ...
    capabilities: [{
        ...
        // 'appium:app': __dirname + '/resources/Android-MyDemoAppRN.1.2.0.build-231.apk'
    ...
    reporters: ['spec',
    ["html-nice", {
        outputDir: `./reports/html-reports/${moment().format('YYYYMMDD-HHmmss')}/`,
        filename: `report.html`,
        reportTitle: 'Login Page Test Report',
